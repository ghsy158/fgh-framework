 ...
 * 
 * @author fgh
 * @Since 2016-8-1 下午5:54:51
 */
public class EncryptUtil {
	private static final String KEY = "hxerp";
	...
	public String decrypt(String strIn) throws Exception {
		return strIn == null ? "" : new String(decrypt(hexStr2ByteArr(strIn)));
	}
	...
	public static void main(String[] args) {
		try {
			...
			System.out.println("解密后的字符：" + EncryptUtil.getInstance().decrypt(des));
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
