Ext.define('Ext.ux.CheckboxCombo', {
	extend : 'Ext.form.field.ComboBox',
	alias : 'widget.checkboxcombo',
	multiSelect : true,
	allSelector : false,
	...
	createPicker : function() {
		var me = this, picker, menuCls = Ext.baseCSSPrefix + 'menu', opts = Ext.apply({
			...
			tpl : [ '<tpl for=".">', '<div class="' + Ext.baseCSSPrefix + 'boundlist-item"><span class="x-combo-checker">&nbsp;</span> {' + me.displayField + '}</div>', '</tpl>' ]
